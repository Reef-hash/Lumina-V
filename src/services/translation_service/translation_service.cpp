...
namespace big
{
	translation_service::translation_service() :
		m_url("https://raw.githubusercontent.com/Mr-X-GTA/LuminaV-Translations/master"),
		m_fallback_url("https://cdn.jsdelivr.net/gh/Mr-X-GTA/LuminaV-Translations@master")
	{
	}
